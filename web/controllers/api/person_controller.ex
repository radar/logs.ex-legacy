defmodule Logs.API.PersonController do
  ...
  def activity(conn, params) do
    ...
    { :ok, result } = Ecto.Adapters.SQL.query(Repo, "SELECT COUNT(*) as count, created_at::DATE as date FROM messages WHERE person_id = #{person.id} GROUP BY created_at::DATE ORDER BY date DESC", [])
